...
<div class="col-lg-6">
	<div class="form-group">
		<label>Usuario</label>
		<input name="Usuario" class="form-control" placeholder="Usuario" value="<?= set_value('Usuario')?>" required <?= $page['disabled']?>/>
	</div>
	<div class="form-group">
		<label>Nombres</label>
	...
	<div class="form-group">
		...
		<input type="Password" name="Password" class="form-control" placeholder="Digite su contraseña" value="" <?= $page['disabledPass']?>>
	</div>
	<div class="form-group">
		<label>Confirmar Contraseña</label>
		<input type="Password" name="Password2" class="form-control" placeholder="Confirme su contraseña" value="" <?= $page['disabledPass']?>>
	</div>
	<div class="form-group">
		<label>Tipo Usuario</label>
		<select name="TipoUsuario" class="form-control" placeholder="Seleccione Tipo Usuario" <?= $page['disabled']?>>
